...
type GenericSearchResult {
    ...
    icon: String!
    # A markdown string that is rendered prominently. Rendered as markdown.
    label: String!
    # The URL of the result.
    url: String!
    # Additional details that is rendered less prominently. Rendered as markdown.
    detail: String
    # The result previews of the result. Rendered as markdown.
